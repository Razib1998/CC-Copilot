/**
 * CCW — Lucide-kompatible SVG-Inhalte (24×24 stroke), rein lokal.
 * Pfade orientieren an Lucide Icons (ISC) — keine Runtime-Loads.
 */

/** @type {Record<string, string>} key → innerHTML (path/rect/line/circle …) */
export const CCW_LUCIDE_SVGS = {
  layoutDashboard:
  ...
  building2:
    '<path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v8h20v-8a2 2 0 0 0-2-2h-2"/><path d="M18 9h2"/><path d="M16 5h2"/><path d="M10 5h2"/><path d="M8 9h2"/>',
  puzzle:
  ...
  handshake:
    '<path d="m11 17 2 2a4 4 0 0 0 6-4"/><path d="M14 21v-4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v4"/><path d="M18 5H6a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Z"/><path d="M12 22v-4"/><path d="M12 13V9"/><path d="M12 13a3 3 0 0 0 3-3V5H9v5a3 3 0 0 0 3 3Z"/><path d="M7 9a2 2 0 0 1-2-2V5"/><path d="M21 9a2 2 0 0 0-2-2V5"/>',
  layout:
...
/**
 * @param {string} iconKey — Schlüssel in CCW_LUCIDE_SVGS
 * @returns {string} komplettes <svg> 16×16 oder leer
 */
export function ccwLucideIconMarkup(iconKey) {
  const inner = CCW_LUCIDE_SVGS[iconKey];
  if (!inner) return '';
